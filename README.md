...
| 3 | 九个品类中只有电视的弹性显著突破补贴盈亏临界线 β=−1 | 电视 **−2.65**（H₀: β=−1，p=0.036）/ 手机 −1.18 / 其余合并 −0.24 |
| 4 | 最优分配把全部预算收敛到两个品类，但整体 ROI 不足 | 优化 **+1.51%** GMV，整体 ROI 仅 **0.30**（仅电视 1.44，手机边际 0.17） |
...
其余七个品类的最优补贴率为零。该结论对「其他品类」那个不显著的弹性估计不敏感——β 取 −0.24 / 0 / −0.52（CI 下界）三种设定，最优解完全相同。
